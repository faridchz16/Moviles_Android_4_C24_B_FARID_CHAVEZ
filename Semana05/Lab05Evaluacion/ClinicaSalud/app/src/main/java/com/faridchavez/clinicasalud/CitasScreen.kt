...
fun CitasScreen(
    ...
    val listaCitas = remember(citas) { mutableStateListOf<Cita>().apply { addAll(citas) } }
    ...
    Column(
        ...
        if (listaCitas.isEmpty()) {
            Box(
                ...
                Text(
                    text = "No tienes citas programadas actualmente",
                    fontSize = 15.sp,
            ...
            LazyColumn(
                ...
                items(listaCitas, key = { it.id }) { cita ->
    ...
    if (citaACancelar != null) {
        AlertDialog(
            ...
            text = { Text(text = "¿Estás seguro de que deseas cancelar la cita con el médico seleccionado?") },
            confirmButton = {
                TextButton(
                    onClick = {
